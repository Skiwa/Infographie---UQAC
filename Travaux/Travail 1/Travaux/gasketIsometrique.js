...
// droite
divideSquare( vertices[3], vertices[2], vertices[5], vertices[6],
                    NumTimesToSubdivide);
                    // dessus
                    divideSquare( vertices[1], vertices[4], vertices[5], vertices[2],
                      NumTimesToSubdivide);
                    // gauche
                    divideSquare( vertices[0], vertices[1], vertices[2], vertices[3],NumTimesToSubdivide);
                      ...
                      // arriere droite
                      divideSquare( vertices[2], vertices[4], vertices[5], vertices[6],
                        NumTimesToSubdivide);
                        // arriere gauche
                        divideSquare( vertices[0], vertices[1], vertices[4], vertices[2],
                          NumTimesToSubdivide);

                    // face du dessous
                    divideSquare( vertices[0], vertices[2], vertices[6], vertices[3],
                      NumTimesToSubdivide);
