...
function cube(side) {
   ...
   face( [-s,-s,s, s,-s,s, s,s,s, -s,s,s], [0,0,1] );       //face
   face( [-s,-s,-s, -s,s,-s, s,s,-s, s,-s,-s], [0,0,-1] );  //arriere
   face( [-s,s,-s, -s,s,s, s,s,s, s,s,-s], [0,1,0] );       //haut
   face( [-s,-s,-s, s,-s,-s, s,-s,s, -s,-s,s], [0,-1,0] );  //bas
   face( [s,-s,-s, s,s,-s, s,s,s, s,-s,s], [1,0,0] );       //droite
   face( [-s,-s,-s, -s,-s,s, -s,s,s, -s,s,-s], [-1,0,0] );  //gauche
   return {
...
function tetra(side) {
  ...
  face( [-s,-s,s, s,-s,s, 0,s,0], [0,0.5,0.5] );       //face
  face( [-s,-s,s, s,-s,s, 0,-s,-s], [0,-1,0] );  //bas
  face( [-s,-s,s, 0,-s,-s, 0,s,0,], [-0.5,0.5,-0.5] ); //gauche
  face( [s,-s,s, 0,-s,-s, 0,s,0], [0.5,0.5,-0.5] );  //droite
...
function triangle(side) {
  ...
  face( [-s,-s,s, s,-s,s, 0,s,s], [0,0,1] );       //face
  face( [-s,-s,-s, s,-s,-s, 0,s,-s], [0,0,-1] );  //arriere
  face( [-s,-s,s, 0,s,s, 0,s,-s, -s,-s,-s], [-.5,.5,0] );  //gauche
  face( [s,-s,s, s,-s,-s, 0,s,-s, 0,s,s], [.5,.5,0] );       //droite
  face( [-s,-s,s, s,-s,s, s,-s,-s, -s,-s,-s], [0,-1,0] );  //bas
  return {
     vertexPositions: new Float32Array(coords),
     vertexNormals: new Float32Array(normals),
